    ...
    onBtnClicked: function(event) {
        ...
        switch (event.target.name) {
            ...
            case 'btn_xiaoxi':
                ...
                break;
            case 'btn_feedback':
                this.feedbakcWin.active = true;
                break;
            case 'head':
                cc.vv.userinfoShow.show(cc.vv.userMgr.userNacreateroleme, cc.vv.userMgr.userId, this.sprHeadImg, cc.vv.userMgr.sex, cc.vv.userMgr.ip);
                break;
            default:
